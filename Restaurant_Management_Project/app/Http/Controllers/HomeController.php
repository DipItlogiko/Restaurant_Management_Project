...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return view('restaurant.home',['allFood' => $allFood , 'authUser' => $authUser, 'tables' => $tables]); //// amra aikhan theke jei allFood name variable ta pass korchi ai allFood variable ta amara use korechi restaurant.home.blade.php file ar food menu section ar moddhe
    }
}
