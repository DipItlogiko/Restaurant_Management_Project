...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return view('restaurant.home',['authUser' => $authUser, 'allFood' => $allFood , 'tables' => $tables , 'chefs' => $chefs ]); //// amra aikhan theke jei allFood name variable ta pass korchi ai allFood variable ta amara use korechi restaurant.home.blade.php file ar food menu section ar moddhe
    }
}
