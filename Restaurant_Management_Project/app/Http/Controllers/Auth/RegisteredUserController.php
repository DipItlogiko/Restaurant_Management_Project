...
class RegisteredUserController extends Controller
{
    ...
    {
        dd($request->all());
        //==== akhane ami 2ta store ar kaj akta store method ar moddhe kore diyechi tai amai akhane if use korechi jokhon admin tar dashboard theke kono user ba admin create korbe create user aa giye tokhon oi request ta ai khane ashbe and if check korbe amader $request ar moddhe kono user_role name kichu ashche kina karon amader admin dashboard a je form ta ache oi khane akta dropdown ache jar name dewa user_role tai akhane set kore diyechi if diye jodi oi form theke kono request ashe ai controller aa tahole ai if ar moddhe jei code gulo ache oi code gulo execute hobe  ====//
        ...
        } else{ ////// jokhon kono user simple signup ba registered korbe tokhon oi form ar moddhe amader kono user_role name input field thakbe na and oi registration form theke jokhon kono request ashbe amader ai controller ar ai store() method ar moddhe tokhon opore if ar condition check korbe oi condition ta milbe na and ai else ar moddhe chole ashbe and ai else ar moddhe jei code gulo ache oi code gulo execute hobe
