          ...
          <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown"><span>McDonald's</span> Restaurant</h2>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-lg-5 align-items-stretch video-box" style='background-image: url("assets/img/about.jpg");'>
          <a href="https://www.youtube.com/watch?v=S-uAsMf1__E" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
        </div>
...
<section id="events" class="events">
    ...
    @include('restaurant.includes.BookTable')
...
<section id="gallery" class="gallery">
    ...
    <!-- ======= Chefs Section ======= -->
    @include('restaurant.includes.Chefs');
    <!-- End Chefs Section -->
        ...
        <div class="info-wrap">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 info mt-4 mt-lg-0">
              ...
              <h4>Open Hours:</h4>
              <p>Saturday-Thursday:<br>11:00 AM - 11:00 PM</p>
            </div>
...
<!--======= This script is for Aleart message auto close =======-->
<script>
