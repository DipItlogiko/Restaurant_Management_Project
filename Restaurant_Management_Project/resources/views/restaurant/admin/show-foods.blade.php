...
<div class="p-4">
    ...
    @else
        ...
        <!---amader controller ar moddhe model ar sathe patinate() ta use korar pore amader aikhane $Foods mane oi variable ar sathe links() add kore dile amader webpage ar moddhe amra pagination ar degine a dekhte pabo and amader links('ar moddhe ami bole diyechi amra bootstrap-5 ar pagination ta use korbo karon amader pagination ar moddhe oonek pagination ache tar moddhe theke ami bootstarp-5 take use korechi amader paginagion ar file gulo pawar jonno amader akta artisan command chalate hoy jei ta laravel10  ar Database Pagination official document ar moddhe bola ache') --->
