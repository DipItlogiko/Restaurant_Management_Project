...
<head>
    ...
    <title>Monthly-Income-PDF!</title>     
...
<div class="m-2">     
    ...
    <p class="text-muted p-0 m-0">Monthly Income Report</p><hr class="style1">
    ...
    <p class="text-end"><strong>Total Amount of Income :</strong> ${{ $totalAmount }}</p>
