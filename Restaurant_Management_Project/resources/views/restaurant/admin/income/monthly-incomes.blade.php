    ...
    <div class="row d-flex justify-content-center align-items-center ">
        ...
        <div class="card text-light border-0 mt-lg-5" style="border-radius: 25px;">
            ...
            <div class="row justify-content-center">
                ...
                <h2 class="text-center fw-bold h1 mb-2 mx-1 mx-md-4 mt-2 mt-lg-3 profile-edit" style="color: #ffb03b" >Monthly Income</h2> 
                <p class="text-center mb-2 mx-1 mx-md-4 mt-2 text-muted">Get Monthly Income PDF</p>
                
                
                
                <form method="post" action="{{ route('monthly.income.pdf') }}" class="mx-1 mx-md-4" enctype="multipart/form-data">
                    @csrf                                         
                ...
                <img src="admin/images/MonthlyIncome.png"
