                 ...
                 <form  method="POST" action="{{ route('admin.food.store') }}" class=" mx-md-4" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                            ...
                            <select id="form3Example3c" name="food_type" class="form-select text-warning form-control" required>                                         
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                            ...
                            <input type="text" id="form3Example3c" name="price" value="{{ old('price') }}" class="form-control text-warning" required/>
