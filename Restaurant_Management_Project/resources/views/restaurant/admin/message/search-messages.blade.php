                ...
                <div class="col-lg-5">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('customser.messages') }}" class="btn btn-outline-warning">Go Back</a>
                    ...
                    <div class="card mb-3 border-0">
                        <div class="table-responsive mt-4">
                            ...
                            <div class="row m-2 pt-3">
                                {{ $allMessages->appends(request()->query())->links('pagination::bootstrap-5')}}  <!----akhane amader pagination digine ar sathe appends(request()->query()) aita add korar karon hocche amader resources/views/restaurant/admin/message/all-messages.blade.php ar moddhe jei search bar ta ache oi search bar ar moddhe kew jodi eemon kono kichu diye search dei ja amader all-messages.blade.php file ar moddhe 7 barer beshi ache tahole amader oi data theke 7 ta 7 ta kore data ak ak page aa dekhabe karon amader ai search ar theke jokhon datata ashche amader searchController.php theke oikhane ami paginate(7) bole diyechi jar mane hocche amader search queary korar pore jei koita data pabe oi data guloke ak ak page ar moddhe 7 ta kore dekhabe......and niche jei pagination ar number gulo thakbe oi number gulote press korle kaj korbe and jodi amra appends(request()->query()) aita na likhi tahole amader search bar moddhe jei data diye search kora hobe oi data ta amader SearchController.php ar moddhe giye paginage hoye amader ai page ar moddhe chole ashbe and database pagination ar digine ta oo dekhabe kintu jokhon ami pagination ar number ar moddhe click korbo tokhon amader click korar por kaj hobe na jodi aita na likhi to aita lekhar r akta karon hocche amader resources/views/restaurant/admin/message/all-messages.blade.php ar moddhe amader pagination kora ache and oikhane akta search bar ache oi search bar ar moddhe kono value diye search korle oi value ta jodi amader oonek bar thake tahole search korar pore amader oi data ta aabar pagination ar sathe show korbe tai--->
                            </div>
            ...
            <div class="modal" id="confirmMessageDeletionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <span class="text-danger">Are you sure you want to Delete this Worker from your Worker records?</span>

                            <div class="text-muted mt-4">
                                Once this Worker is Deleted, all of it's resources and data will be permanently delete. Please press on Delete button to confirm you would like to permanently Delete this Worker from your Worker records. 
                            </div>
                        </div>
