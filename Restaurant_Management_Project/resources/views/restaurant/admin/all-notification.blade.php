...
<div class="container mt-3">
    ...
    @else
        ...
        <div class="text-end"><a href="{{ route('delete.All.Notification') }}"  class="btn btn-outline-danger delete-notification-button">Clear All</a></div>  
                ...
                <div class="card mb-3 border-0">
                    <div class="table-responsive mt-4">
                        ...
                        @foreach($allNotifications as $data)
                            <tr>
                                <td>
                                    <img src="Users_images/{{ $data->image }}" alt="">
                                </td> 

                                <td>{{ $data->name }}</td>   

                                @if ($data->booked_table !== null)
                                    <td>{{ $data->booked_table }} Table Is Booked!!!</td>
                                @else
...
<script>
    $(document).ready(function() {
        $('.delete-notification-button').on('click', function() {
            ...
            modal.find('a.btn-outline-danger').attr('href', '/deleteNotification' + notificationId); ///// jokhon kew amar delete confirmation model ar moddhe jei delete button ache oi button aaa click korbe tokhon amader oi user ar id ta akhan theke pass hoye jabe amader route/web.php file ar moddhe /deleteNotification{id}
            modal.modal('show');
        });
