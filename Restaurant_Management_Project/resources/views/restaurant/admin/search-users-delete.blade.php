            ...
            <div class="col-lg-5">
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.delete.user') }}" class="btn btn-outline-warning">Go Back</a>
