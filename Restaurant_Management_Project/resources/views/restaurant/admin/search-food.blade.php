...
<div class="p-4">
            ...
            <div class="col-lg-5">
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.show.foods') }}" class="btn btn-outline-warning">Go Back</a>
    ...
    @else
          ...
          <!--==== End Flash Message ====-->
            ...
            <div class="search-container">
                <div class="input-box rounded-pill">
                    ...
                    <form action="{{ route('search.food') }}" method="get"> <!--search ar jonno amra get method ee use kori--->
        ...
        {{ $Foods->appends(request()->query())->links('pagination::bootstrap-5') }}   <!----akhane amader pagination digine ar sathe appends(request()->query()) aita add korar karon hocche amader resources/views/restaurant/admin/show-foods.blade.php ar moddhe jei search bar ta ache oi search bar ar moddhe kew jodi eemon kono kichu diye search dei ja amader show-foods.blade.php file ar moddhe 7 barer beshi ache tahole amader oi data theke 7 ta 7 ta kore data ak ak page aa dekhabe karon amader ai search ar theke jokhon datata ashche amader searchController.php theke oikhane ami paginate(7) bole diyechi jar mane hocche amader search queary korar pore jei koita data pabe oi data guloke ak ak page ar moddhe 7 ta kore dekhabe..and niche jai pagination ar number gulo thakbe oi number gulote press korle kaj korbe and jodi amra appends(request()->query()) aita na likhi tahole amader search bar moddhe jei data diye search kora hobe oi data ta amader SearchController.php ar moddhe giye paginage hoye amader ai page ar moddhe chole ashbe and database pagination ar digine ta oo dekhabe kintu jokhon ami pagination ar number ar moddhe click korbo tokhon amader click korar por kaj hobe na jodi aita na likhi to aita lekhar r akta karon hocche amader resources/views/restaurant/admin/show-foods.blade.php ar moddhe amader pagination kora ache and oikhane akta search bar ache oi search bar ar moddhe kono value diye search korle oi value ta jodi amader oonek bar thake tahole search korar pore amader oi data ta aabar pagination ar sathe show korbe tai--->
        </div>
