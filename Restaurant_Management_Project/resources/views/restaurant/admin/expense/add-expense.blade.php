        ...
        <div class="card text-black border-0" >
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1 pt-lg-5 mt-lg-5">
                 ...
                 <h2 class="text-center fw-bold h1 mb-2 mx-1 mx-md-4 mt-2 text-light font">Add<span style="color: #ffb03b">Expense</span></h2> 

                <form action="{{ route('store.expense') }}"  method="post" class=" mx-md-4" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example1c" name="expense_type" value="{{ old('expense_type') }}" class="form-control text-warning" required/>
                        <label class="form-label text-light" for="form3Example1c">Expense Type</label>
                    </div>
                    </div>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                            ...
                            <input type="text" id="form3Example3c" name="total_price" value="{{ old('total_price') }}" class="form-control text-warning" required/>
                            <label for="total_price" class="form-label text-light" for="form3Example3c">Total Price</label>
                        </div>
                    </div>                      
                ...
                <img src="admin/images/expense.png"
